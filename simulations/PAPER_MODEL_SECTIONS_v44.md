...
**Vismodegib arrests medulloblastoma by dropping Cyclin D1 below a p16/p21-raised commitment threshold,
...
6. **A combined INK4 (p16+p18) + CIP/KIP (p21/p27) CDK-inhibitor brake gives the strong vismodegib
   ...
   **CDK4/6i (palbociclib) is a non-competitive Vmax block (kPhRbCd=0) that Cyclin D1 cannot bypass →
   ...
   drop + the combined p16/p21 brake the rescue is a clean Cyclin D1-threshold effect.)*
