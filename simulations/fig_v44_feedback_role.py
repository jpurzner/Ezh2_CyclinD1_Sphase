...
(f0_prc2 -> 1.0, i.e. the H3K27me3 mark is present but cannot repress CyclinD1, as in 'most cells') across
...
M_no = build_model_v44(params={"f0_prc2": 1.0})                   # feedback OFF (H3K27me3 mark cannot repress Cd)
