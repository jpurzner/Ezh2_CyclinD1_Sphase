...
Also compares WITH feedback (real model) vs WITHOUT (K_EZH2_repression=1e6): if the feedback buffers
...
B = rampdown(build_model_v44(params={"K_EZH2_repression": 1e6}))  # without feedback
