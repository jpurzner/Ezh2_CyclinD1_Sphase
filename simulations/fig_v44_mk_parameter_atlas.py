...
def _init(_):
    ...
    _RR = te.loada(build_model_v44(with_ezh2=True, with_hh=True, with_h3k27_chain=False, with_two_step_rb=False))
...
def main():
    ...
    if not fresh and os.path.exists(CACHE):
        ...
        return
    import tellurium as te
    r0 = te.loada(build_model_v44(with_ezh2=True, with_hh=True, with_h3k27_chain=False, with_two_step_rb=False))
