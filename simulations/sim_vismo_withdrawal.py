...
(MYCN-floor) CyclinD1 is repressed below threshold -> ARREST; WITHOUT it (no-fb = f0_prc2 -> 1.0, the
...
FB_OFF = 1.0            # feedback knockout: f0_prc2=1 -> R==1, mark cannot repress (= EZH2i / tazemetostat)
